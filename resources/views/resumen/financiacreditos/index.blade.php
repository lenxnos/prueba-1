...
<div class="container">
  <div class="row">
    {!! Breadcrumbs::render('financiacreditos_index') !!}
  </div>
</div>
...
<div class="container">
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading">   Administración de Fuentes de Finanaciamientos para Créditos Adicionales   </div>

      <div class="panel-heading">
        <ul>
          <li>
           <a href="{{ Route('financiacreditos.create') }}">
